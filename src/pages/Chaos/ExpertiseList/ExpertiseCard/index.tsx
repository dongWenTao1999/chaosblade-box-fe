...
const ExpertiseCard: FC<IProps> = props => {
  ...
  function handleCreateExperiment() {
    ...
    Message.show({
      type: 'notice',
      title: (
        <Translation>{`${i18n.t('Supported by current experience')}${type.join(',')}${i18n.t('Application type')}`}</Translation>),
      ...
      if (item === 0) {
        return (
          <Balloon
            ...
            trigger={<img className={styles.machinetype}
                          src="https://img.alicdn.com/imgextra/i4/O1CN01pLgvOf1WxB137tbc2_!!6000000002854-55-tps-16-16.svg"
                          alt=""/>}
          >
      ...
      if (item === 2) {
        return (
          <Balloon
            ...
            key={`${item}scope${index}`}
            trigger={<img className={styles.machinetype}
                          src="https://img.alicdn.com/imgextra/i2/O1CN01N1ebdb27JSSGoC0RF_!!6000000007776-55-tps-16-16.svg"
                          alt=""/>}
          >
  ...
  return (
    <div className={classnames(styles.card, activeBorder)} onClick={handleClick}>
      ...
      <div className={styles.describe}
           title={expertise && expertise.function_desc}>{expertise && expertise.function_desc}</div>
      <div>
      ...
      {!props.noFooter ? <div className={styles.ButtonGroup}>
        <Button type='primary' className={styles.addRun} onClick={handleCreateExperiment}><Translation>create
